...
Use this command when the work needs company-level DBLVSN judgment before production starts.

Steps:

1. Treat any text after the slash command as the executive brief.
